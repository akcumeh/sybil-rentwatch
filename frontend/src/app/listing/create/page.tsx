                        ...
                        <AnimatePresence mode="wait">
                            {published ? (
                                <motion.div
                                    ...
                                    className="flex items-center gap-3 border border-scanner/40 bg-scanner/5 text-scanner p-4 rounded-sm font-body text-sm font-bold uppercase tracking-wider"
                                >
                                    <span className="w-2 h-2 rounded-full bg-scanner animate-pulse shrink-0" />
                                ...
                                <motion.button
                                    ...
                                    className="w-full bg-scanner text-void font-body font-bold text-[13px] uppercase tracking-wider py-4 rounded-sm hover:brightness-110 transition-all shadow-[0_0_15px_rgba(0,229,204,0.3)] hover:shadow-[0_0_25px_rgba(0,229,204,0.5)]"
                                >
                                    Publish Listing →
                                </motion.button>
                            )}
