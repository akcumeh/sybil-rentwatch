  ...
  return (
    <main className="min-h-screen bg-void bg-grid-texture relative overflow-hidden flex flex-col items-center justify-center p-8">
      ...
      <div className="z-10 flex flex-col items-center gap-16 max-w-4xl w-full">
        ...
        {/* HUD Data Row */}
        <div className="flex flex-wrap items-center justify-center gap-12 bg-surface-0/80 backdrop-blur-md p-6 border border-border-subtle rounded-sm shadow-xl animate-fade-up" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
